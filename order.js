document.addEventListener('DOMContentLoaded', () => {
    ...
    if (page === 'product-summary.html') {
        ...
        const order = {
            ...
            isGift: localStorage.getItem('order_isGift') === 'true',
        ...
        document.getElementById('summary-packaging').textContent = order.isGift ? 'Gift (no box)' : 'With box';
